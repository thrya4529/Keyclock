...
exec "$JAVA" $KC_OPTS -cp $DIRNAME/client/keycloak-admin-cli-26.6.1.jar --add-opens=java.base/java.security=ALL-UNNAMED --enable-native-access=ALL-UNNAMED -Dkc.lib.dir=$DIRNAME/client/lib org.keycloak.client.admin.cli.KcAdmMain "$@"
